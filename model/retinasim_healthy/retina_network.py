...
def retina_simulation(time_in_ms, sp, lstim, delta_ve_folder=None, delta_ve_dt=0.01, simulation_timestep=None, debug=False, gpu=True, select_GPU=None, genn_directory=None):
